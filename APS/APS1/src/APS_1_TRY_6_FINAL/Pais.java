 ...
 * @author augus
 */
public class Pais extends APS_1_try_5 {
...
//CONSTRUTOR
    ...
    public String toString() {
        if (L) {
            return "Nome: " + Nome + ", Dominio: " + Dominio + ", Capital: " + Capital + ", Região: " + Regiao + ", Lingua: " + Lingua + ", Moeda: " + Moeda;
    ...
    /*
     ...
     while(true){
     int p = text.indexOf("\"name\":\"");
     if(p == -1){
     break;
     }
     String nome = text.substring(p, p+100);
     ...
     Hashtable<String,ArrayList<Pais>> dic = new Hashtable<>();
     dic.put("america", new ArrayList());
     dic.put("europa", new ArrayList());
        
        
     for (int i = 0; i < listaPaises.size(); i++) {
     Pais p = listaPaises.get(i);
     System.out.println(p);
     ArrayList list = dic.get(p.getRegiao());
     list.add(p);
     }
     }
